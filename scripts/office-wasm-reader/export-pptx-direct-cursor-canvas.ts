...
async function loadPresentationRendererHelpers(): Promise<PresentationRendererHelpers> {
  const imported = await import("../../src/app/debug/office-wasm-poc/presentation-renderer");
...
async function loadOfficePreviewHelpers(): Promise<OfficePreviewHelpers> {
  const imported = await import("../../src/app/debug/office-wasm-poc/office-preview-utils");
