...
const en: TranslationDictionary = {
  ...
  home: {
    ...
    setupGateHint: "Finish the checklist above before unlocking recovery and advanced tools. The home page now organizes the starting paths by collaboration surface.",
    whatToAdvance: "Which collaboration surface do you want to enter?",
    homePrimaryHint: "Pick a collaboration surface first. The Sessions surface handles direct work and recovery, the Kanban surface handles routing and execution, and the Team surface handles multi-specialist delegation.",
    surfaceLabel: "Collaboration Surface",
    sessionsSurfaceTitle: "Sessions Surface",
    kanbanSurfaceTitle: "Kanban Surface",
    teamSurfaceTitle: "Team Surface",
