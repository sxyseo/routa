...
const en: TranslationDictionary = {
  ...
  settings: {
    ...
    workspaceDangerZone: {
      ...
      description: "Permanently delete this workspace and all its data (boards, tasks, sessions, notes, artifacts). This action cannot be undone.",
      renameTitle: "Rename Workspace",
      newNamePlaceholder: "Enter new workspace name",
      saveName: "Save Name",
      renaming: "Saving…",
      renamedSuccess: "Workspace renamed successfully.",
      confirmPlaceholder: "Type the workspace name to confirm",
      deleteButton: "Delete Workspace",
      confirmButton: "Confirm Deletion",
      deleting: "Deleting…",
      deletedSuccess: "Workspace deleted. Redirecting…",
