...
- Additional verification: `/Users/phodal/Downloads/Copy of CAG RFP - Schedule 8 - Operations and maintenance - Onshore.docx` now parses through Routa (`2124842` proto bytes). Walnut still throws on that file's invalid decimal page-margin value (`1440.0000000000002`), so it is tracked as Routa robustness beyond Walnut parity rather than a Walnut-comparable sample.
