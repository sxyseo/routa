...
- [ ] DOCX chart payload depth: chart references and basic cached series are present; remaining work is richer axis/title/legend/plot-area styling, multi-axis charts, and embedded chart workbook/cache edge cases.
