...
- [ ] DOCX advanced document features: headers/footers, comments, footnotes/endnotes, track changes, hyperlinks, bookmarks, content controls, equations, floating/anchored images, charts, complex section/layout handling, and full style inheritance.
