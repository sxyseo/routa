...
- Conditional formatting breadth: color scales, data bars, icon sets, text/cell rules, negative data bars, explicit axes, and cfvo thresholds are handled. Remaining work is wider layered-rule precedence coverage and less-common Excel conditional-format rule families.
